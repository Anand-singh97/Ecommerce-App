...
const NewsLetter = () => {
  return (
    <div className='flex flex-col mx-3 md:mx-[3rem] py-5 bg-[conic-gradient(at_right,_var(--tw-gradient-stops))] from-rose-200 to-orange-100 lg:mx-[5rem] lg:px-[10rem] md:px-[2rem] items-center gap-3 justify-center'>
        ...
        <div className='border-2 h-[3rem] border-gray-200 flex justify-between rounded-full'>
