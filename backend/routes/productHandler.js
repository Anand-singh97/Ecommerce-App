...
productRouter.post("/updateProduct", singleUpload, async (req, res) => {
  const { productId, name, category, new_price, old_price } = req.body;
...
productRouter.post("/getSingleProduct", async (req, res) => {
  try {
